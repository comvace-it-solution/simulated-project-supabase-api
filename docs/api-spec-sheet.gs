  ...
  const apiSpecs = [
    ...
    },
    {
      ...
      response200: [
        ...
        ["8", "birthDate", "-", "◯", "string(date)", "生年月日"],
        ["9", "assignmentDate", "◯", "-", "string(date)", "配属日"],
        ["10", "currentAttendanceState", "-", "◯", "number", "現在の勤怠状態"],
        ["11", "currentAttendanceId", "-", "◯", "number", "現在の勤怠ID"],
      ],
      responseError: [
        ["No.", "ステータス", "message", "発生条件"],
    ...
    },
    {
      ...
      responseError: [
        ...
        ["22", "405", "許可されていないHTTPメソッドです。", "PUT以外でアクセス"],
